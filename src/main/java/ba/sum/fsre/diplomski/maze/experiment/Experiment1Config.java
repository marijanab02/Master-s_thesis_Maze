...
public class Experiment1Config {
    ...
    public static final int RUNS_PER_COMBINATION = 30;
    ...
    public static final String RAW_CSV_FILE = RESULTS_DIR + "/experiment1_imperfect_maze_raw.csv";

    public static final String AGGREGATED_CSV_FILE = RESULTS_DIR + "/experiment1_imperfect_maze_aggregated.csv";

    public static final int Q_LEARNING_TRAIN_EPISODES = 3000;
